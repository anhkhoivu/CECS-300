                ...
                <div class="row">
                    ...
                    foreach ($items as $item) {
                        ...
                        <div class="<?php echo esc_attr($classes); ?>">
                            <?php
                            $excerpts = array('Catch up on the social media campaign that accumulated millions of views.',
                            'Want to share your story? It can be an existing blog, video, or new one.',
                            'Join #ASLFamiliesChat every month on Twitter as we discuss current issues.',
                            'Get weekly emails listing the latest stories, facts & events posted on ASL Families!');
                            // the_excerpt();
                                ...
                                case 'icon':
                                    ...
                                    <div class="card card-block service__media-icon">
                                        <div class="service-card-content">
                                            <h3 class="card-title"><a href="<?php the_permalink(); ?>"><?php the_title(); echo ' >>'; ?></a></h3>

                                            <?php echo '<div class="card-text">'.$excerpts[$count - 1].'</div>'; ?>
                                        </div>
                                        <?php if ($item['icon']) { ?>
                                ...
                                case 'no_thumb':
                                    ...
                                    <div class="card card-block">
                                        <div class="service-card-content">
                                            ...
                                            <?php echo '<div class="card-text">'.$excerpts[$count - 1].'</div>'; ?><!-- <p class="card-text"><?php the_excerpt(); ?></p> -->
                                            <?php if ($item['readmore']) {
                                                ?>
                                                <a href="<?php the_permalink(); ?>" class="service-button"><?php echo $text; ?></a>
                                            <?php } ?>
